...
from datasets.heart_data_pc import Heart15kPointClouds
...
class Model(nn.Module):
    def __init__(self, args, betas, loss_type: str, model_mean_type: str, model_var_type:str):
        ...
        self.model = PVCNN2(num_classes=args.nc, embed_dim=args.embed_dim, use_att=args.attention,
                            dropout=args.dropout, extra_feature_channels=1)
...
def get_dataset(dataroot, npoints,category,use_mask=False):
    tr_dataset = Heart15kPointClouds(root_dir=dataroot,
    ...
    te_dataset = Heart15kPointClouds(root_dir=dataroot,
...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/mnt/data1/shared/data/tanish-sph-v2')
    parser.add_argument('--category', default='AP')
    ...
    parser.add_argument('--npoints', default=16384)
    '''model'''
